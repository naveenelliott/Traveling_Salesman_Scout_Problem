...
asa_data.drop(columns=['Season', 'Claiming', 'Handling', 'Shotstopping', 'Passing', 'Sweeping', 'Unnamed: 0'], inplace=True)

asa_data['Goals Added p90'] = (asa_data['Goals Added']/asa_data['Minutes']) * 90



asa_data.to_csv('asa_data_gk.csv', index=False)